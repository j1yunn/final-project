...
('user1@example.com', '레고매니아', '1111', 0),
('user2@example.com', '신발控', '1111', 0),
('user3@example.com', '건담수집가', '1111', 0),
('admin@example.com', '관리자', '1111', 1);
...
('레고 테크닉 그것이 알고 싶다', '레고 테크닉 정보 공유...', 1, 150),
('레고 스타워즈', '레고 스타워즈 제품 공유...', 1, 150),
('레고 시티 소방서', '레고 시티 소방서 정보 공유...', 1, 150),
('레고 마블', '레고 마블 신제품 공유...', 1, 150),
('레고 dc', '레고 dc 정보 공유...', 1, 150);


-- 중고 게시글 데이터
INSERT INTO board (title, content, user_id, view_cout) VALUES
('레고 시티 소방서', '레고시티 소방서 팝니다', 1, 100),
('나이키 에어맥스 리뷰', '편안한 나이키 에어맥스 사용 후기입니다...', 2, 50),
('HG 건담 바바토스 조립 팁', 'HG 건담 바바토스 조립 시 주의할 점과 팁 공유...', 3, 200),
